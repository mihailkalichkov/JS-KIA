 ...
 */
mindmaps.CanvasPresenter = function (eventBus, commandRegistry, mindmapModel, view) {
    var self = this;
    ...
    creator.dragStarted = function (node) {
        ...
        var color = node.isRoot() ? mindmaps.Util.randomColor() : node.branchColor;
        return color;
    };
    ...
    function showMindMap(doc) {
        ...
        view.setDimensions(4000, 2000); //dimensions x and y
        var map = doc.mindmap;
        view.drawMap(map);
        view.center();
    ...
    function bind() {
        ...
        eventBus.subscribe(mindmaps.Event.DOCUMENT_OPENED, function (doc, newDocument) {
            showMindMap(doc); 
        });
