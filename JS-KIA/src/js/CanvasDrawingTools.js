mindmaps.CanvasDrawingUtil = {
     ...
     * @returns {Number}
     */
    getLineWidth: function (depth) {
        var width = (12 - depth * 2);
...
mindmaps.CanvasBranchDrawer = function () {
    ...
    this.render = function (ctx, depth, offsetX, offsetY, $node, $parent, color, zoomFactor) {
        ...
        var lineWidth = mindmaps.CanvasDrawingUtil.getLineWidth(depth);
        ...
        var pLineWidth = mindmaps.CanvasDrawingUtil.getLineWidth(depth - 1);
...
mindmaps.TextMetrics = (function () {
    ...
    return {
         ...
         */
        getTextMetrics: function (node, text) {
